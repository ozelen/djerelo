	...
	<![CDATA[ <html> ]]>
			<head>
				<title>
					...
					<xsl:value-of select="$title"/> <xsl:value-of select="//seo-title"/> <inject id="title-{/out/@lang}"></inject>
				</title>
				<!-- TPL: HEAD-INCLUDES -->
			...
			<div align="center" style="padding:0 0">
				...
				<div style="background:white; height:110px; width:960px; margin:10px 0">
					<iframe width="960" height="110" src="http://skiworld.org.ua/program/bn/index.php?id=dovbushanka" frameborder="0"></iframe>
				</div>
